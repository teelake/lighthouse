document.addEventListener('DOMContentLoaded', function() {
    ...
    function setSectionStagger(section) {
        if (!section) return;
        var idx = 0;
        section.querySelectorAll('.gather-card, .event-card-modern, .moment-item, .lights-content, .lights-image, .prayer-wall-image, .prayer-wall-content, .voice-quote, cite, .newsletter-form, .section-sub, .sermon-card, .media-card, .glimpse-item').forEach(function(el) {
