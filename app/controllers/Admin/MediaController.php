...
{
    public function index() { $this->requireEditor(); $this->render('admin/media/index', ['media' => (new Media())->findAll([], 'published_at DESC', 50)]); }
    public function create() { $this->requireEditor(); $this->render('admin/media/form', ['item' => null]); }
    ...
    public function edit() { $this->requireEditor(); $m = (new Media())->find($this->params['id'] ?? 0); if (!$m) throw new \Exception('Not found', 404); $this->render('admin/media/form', ['item' => $m]); }
