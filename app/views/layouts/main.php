    ...
    <header class="site-header" id="site-header">
        <div class="header-inner">
            ...
            <div class="header-actions">
                <?php $s = new \App\Models\Setting(); $sf = $s->get('social_facebook', ''); $si = $s->get('social_instagram', ''); $sy = $s->get('social_youtube', ''); $st = $s->get('social_twitter', ''); if ($sf || $si || $sy || $st): ?>
        ...
        <div class="footer-inner">
            <div class="footer-brand">
                ...
                <div class="footer-social-wrap">
                    ...
                    if ($sTw): ?><a href="<?= htmlspecialchars($sTw) ?>" target="_blank" rel="noopener noreferrer" aria-label="Twitter"><svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a><?php endif;
                    ?>
                    </div>
                </div>
                <?php endif; ?>
