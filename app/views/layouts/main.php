    ...
    <header class="site-header" id="site-header">
        <div class="header-inner">
            ...
            <div class="header-actions">
                <?php $s = new \App\Models\Setting(); $sf = $s->get('social_facebook', ''); $sy = $s->get('social_youtube', ''); $st = $s->get('social_twitter', ''); $sTk = $s->get('social_tiktok', ''); if ($sf || $sy || $st || $sTk): ?>
        ...
        <div class="footer-inner">
            <div class="footer-brand">
                ...
                <?php
                    ...
                    $sFb = $sFooter->get('social_facebook', ''); $sYt = $sFooter->get('social_youtube', ''); $sTw = $sFooter->get('social_twitter', ''); $sTk = $sFooter->get('social_tiktok', '');
                    $hasSocial = $sFb || $sYt || $sTw || $sTk;
                if ($hasSocial): ?>
