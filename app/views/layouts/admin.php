        ...
        <div class="sidebar-brand">
            <a href="<?= $adm ?>" class="sidebar-brand-link">
                <span class="sidebar-logo">
                    ...
                    <img src="<?= htmlspecialchars($logoUrl) ?>" alt="Lighthouse" class="sidebar-logo-img">
                    <?php else: ?>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-collapse" data-group="content">
                ...
                <div class="nav-collapse-panel" id="nav-content">
                    ...
                    <a href="<?= admin_url('academy-registrations') ?>" class="nav-item <?= ($currentPage ?? '') === 'academy-registrations' ? 'active' : '' ?>" data-tooltip="Academy Sign-Ups"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg><span class="nav-text">Academy Sign-Ups</span></a>
                </div>
            </div>
            <?php endif; ?>
            <?php if ($isAdmin): ?>
            <div class="nav-collapse" data-group="system">
                ...
                <div class="nav-collapse-panel" id="nav-system">
                    ...
                    <a href="<?= admin_url('users') ?>" class="nav-item <?= ($currentPage ?? '') === 'users' ? 'active' : '' ?>" data-tooltip="Staff"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg><span class="nav-text">Staff</span></a>
                    <a href="<?= admin_url('members') ?>" class="nav-item <?= ($currentPage ?? '') === 'members' ? 'active' : '' ?>" data-tooltip="Members"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg><span class="nav-text">Members</span></a>
