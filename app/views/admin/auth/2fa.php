...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .logo { display: block; margin-bottom: 1rem; font-size: 1rem; font-weight: 800; letter-spacing: 0.18em; color: #facc15; }
        h1 { margin: 0 0 0.5rem; color: #0f172a; font-size: 1.5rem; font-weight: 800; letter-spacing: -0.02em; }
        ...
        button { width: 100%; padding: 0.875rem; background: #0f172a; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 1rem; font-family: inherit; transition: background 0.2s; }
        button:hover { background: #1e293b; }
        .error { background: #fef2f2; color: #dc2626; padding: 0.9rem; border-radius: 10px; margin-bottom: 1rem; font-size: 0.9rem; }
        .back { display: block; margin-top: 1.25rem; color: #64748b; font-size: 0.9rem; text-decoration: none; font-weight: 500; }
