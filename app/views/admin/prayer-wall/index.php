...
<div class="admin-card">
    <h2 class="card-title">Prayer Requests</h2>
        ...
        <table class="admin-table">
            ...
            <?php foreach ($requests as $r): ?>
                <tr>
                    ...
                    <td>
                        <form method="post" action="<?= admin_url('prayer-wall/requests/' . ($r['id'] ?? '') . '/delete') ?>" style="display:inline;" onsubmit="return confirm('Delete this request?');">
                            <?= csrf_field() ?>
...
<div class="admin-card">
    <h2 class="card-title">Prayer Wall Posts</h2>
        ...
        <table class="admin-table">
            ...
            <?php foreach ($posts as $p): ?>
                <tr>
                    ...
                    <td>
                        <form method="post" action="<?= admin_url('prayer-wall/posts/' . ($p['id'] ?? '') . '/delete') ?>" style="display:inline;" onsubmit="return confirm('Delete this post?');">
                            <?= csrf_field() ?>
                            <button type="submit" class="btn btn-sm btn-danger">Delete</button>
                        </form>
                    </td>
