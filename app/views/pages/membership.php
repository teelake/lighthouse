    ...
    <div class="container membership-content">
        <div class="membership-intro">
            ...
            <div class="about-story-body">
                <?= rich_content($membershipIntro ?? 'Pharos Ministries offers structured pathways for membership, discipleship, and leadership development. Whether you\'re new to faith or ready to step into greater responsibility, our academies are designed to equip you for impact.') ?>
            </div>
        </div>
        ...
        <div class="about-pillars membership-pillars">
            <div class="about-pillar stagger-item">
                ...
                <div class="about-pillar-text"><?= rich_content($sections['membership_pharos']['content'] ?? 'Become a covenant member of Lighthouse. Learn our values, vision, and commitment to one another. Membership connects you to the family and opens doors for service.') ?></div>
            </div>
            <div class="about-pillar stagger-item">
                <div class="about-pillar-icon" aria-hidden="true">
                ...
                <div class="about-pillar-text"><?= rich_content($sections['membership_leadership']['content'] ?? 'For those called to lead. Develop character, vision, and practical skills to serve in ministry and beyond.') ?></div>
            </div>
            <div class="about-pillar stagger-item">
                <div class="about-pillar-icon" aria-hidden="true">
                ...
                <div class="about-pillar-text"><?= rich_content($sections['membership_discipleship']['content'] ?? 'Go deeper in your walk with Christ. Systematic teaching, accountability, and practical application for everyday life.') ?></div>
            </div>
        </div>
