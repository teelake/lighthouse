...
if (!function_exists('svg_icon')) {
    ...
    {
        $icons = [
            'calendar' => '<path d="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z"/><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M3 10h18"/>',
